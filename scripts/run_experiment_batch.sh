...
case "$TIER" in
  ...
  q1-v4-maze)
    ...
    ;;
  q1-v4-maze-genetic|q1-v4-maze-random)
    EXP_DIR="$EXP_ROOT/${MAZE_EXPERIMENT_ROOT:-q1-v4-maze}"
    RUN_FILTER=false
    RUN_SHADOW=false
    RUN_MAZE=true
