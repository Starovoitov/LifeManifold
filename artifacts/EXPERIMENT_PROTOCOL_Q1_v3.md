...
| **Deliverable** | Per-seed PDFs + `archive_heatmaps/*.png` + panel `fig07_archive_heatmaps_panel_seeds4_6_1.pdf`; main text Fig.~7 = seed 4 |
| **Not in scope (v3)** | Automated Coverage-Difference overlay |
| **Reproduce** | `.venv/bin/python scripts/export_manuscript_figures.py --fig 7 --panel` (default seed order 4,6,1) |
