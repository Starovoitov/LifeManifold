...
| 2026-08-24 | **Manuscript prose pass, 19–24 Aug (Reporting):** Claim-facing and appendix wording only (abstract/intro/methods/results/discussion; appendices A–C, G, J, K, N, Q). Q.43 in the manuscript now lists freeze/status events; wording-only edits are not protocol amendments. Notable Q wording: internal freeze vs OSF preregistration; dungeon v4 Lock vs matched H2 Reporting; H4 = Lock plus later Reporting; mtime does not establish first inspection. **No new QD runs.** Holm unchanged. |
