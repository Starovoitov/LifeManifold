...
| 2026-08-17 | **RQ1 second-domain maze Phase A GO (Extension):** 10/10. @ 5k minfit **16.79 ± 3.29%** vs frozen uniform **56.98 ± 4.47%**; Δ **−40.19 ± 4.13 pp** (10/10). Terminal 45.11% vs 99.62% (uniform saturates; minfit does not). [`ANALYSIS.md`](experiments/q1-v5-maze-genetic-minfit/ANALYSIS.md). Phase B LLM 2×2 authorized, **not launched**. **Not Holm; does not amend H5 / CA RQ1.** |
