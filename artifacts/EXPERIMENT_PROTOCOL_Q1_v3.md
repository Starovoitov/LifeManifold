...
| 2026-08-17 | **Genetic `max_fitness_frontier` wiring (Extension, not launched):** policy + YAML `map_elites_scheduler_nightly_genetic_me_maxfit.yaml` + tier `q1-v3-genetic-me-maxfit`. Descriptive third archive policy on 20R+30G; same warm-start floor. Protocol [`Q1_GENETIC_MAXFIT.md`](Q1_GENETIC_MAXFIT.md). **Does not amend Holm / H2 / RQ1.** |
