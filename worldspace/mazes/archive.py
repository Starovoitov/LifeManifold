"""Maze-specific grid archive and JSONL persistence."""
...
class MazeArchive:
    ...
    def __init__(self, resolution: int = 30) -> None:
        ...
        self._cells: list[MazeElite | None] = [None] * (resolution**2)
    ...
    def get_cell(self, cell_id: int) -> MazeElite | None:
    ...
    def try_insert(self, elite: MazeElite) -> InsertResult:
    ...
    def elites(self) -> list[MazeElite]:
                    ...
                    json.dumps(
                        {
                            ...
                            "maze_spec": elite.spec.to_json_dict(),
                            "metadata": {
